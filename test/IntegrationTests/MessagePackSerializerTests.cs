...
namespace Whitestone.Cambion.Serializer.MessagePack.IntegrationTests
{
    public class MessagePackSerializerTests
    {
        ...
        {
            const string expectedBase64 = "";

            MessageWrapper messageWrapper = new()
            {
        ...
        public async Task DeserializeAsync_DefaultObject_Success()
        {
            ...
            byte[] data = Convert.FromBase64String("");
